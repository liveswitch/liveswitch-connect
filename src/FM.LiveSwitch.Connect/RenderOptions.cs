...
{
    [Verb("render", HelpText = "Renders remote media to a named pipe.")]
    class RenderOptions : ReceiveOptions
    {
        ...
        [Option("client", Required = false, HelpText = "Use a named pipe client.")]
